...
PhoneStr     = constr(regex=r'^\+?[0-9]{7,15}$')
GenderStr    = constr(strip_whitespace=True, max_length=1, regex=r'^[MFO]$')  # M, F, O
...
class EmployeesList(BaseModel):
    ...
    active_at     : date = Field(..., description="Date when the employee became active")
